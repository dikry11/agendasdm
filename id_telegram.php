...
<head>
  ...
  <title>E-AGENDA | Input Surat Telegram Masuk</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tastelegram.php">Telegram Masuk</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_str (tgl, no_surat, tglsurat, perihal) VALUES ('$tgl', '$no_surat', '$tglsurat', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tastelegram.php";</script>';
        }else{
