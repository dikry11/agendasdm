...
<head>
  ...
  <title>E-AGENDA | Input Surat Perintah Masuk</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasspmasuk">Surat Perintah Masuk</a></li>
...
<?php
 ...
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_spmasuk (tgl, no_surat, dari, perihal, ket) VALUES ('$tgl', '$no_surat', '$dari', '$perihal', '$ket')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tasspmasuk.php";</script>';
        }else{
