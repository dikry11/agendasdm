...
<head>
  ...
  <title>E-AGENDA | EDIT SB RAHASIA</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_sbrahasia WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_sbrahasia SET  tgl='$tgl', no_surat='$no_surat',kpd='$kpd', perihal='$perihal' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="taskeluarrahasia.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editsbrahasia.php?id=<?php echo $id; ?>" method="post">
...
<button type="submit" class="btn btn-primary" name="bsimpan" ><span class="glyphicon glyphicon-ok"></span> Simpan</button>
 ...
 <!-- /.content-wrapper -->
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="http://pusdikmin.com/index.php?r=site/home" target="_blank">
  </footer>
