...
<head>
  ...
  <title>E-AGENDA | Input Surat Biasa Masuk</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasmasuk.php">Surat Masuk Biasa</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_sbmasuk (tgl, no_surat, dari, perihal) VALUES ('$tgl', '$no_surat', '$dari', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tasmasuk.php";</script>';
        }else{
