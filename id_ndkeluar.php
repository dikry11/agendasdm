...
<head>
  ...
  <title>E-AGENDA | Input Nota Dinas Keluar</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ndkeluar.php">Nota Dinas Keluar</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_ndkeluar (tgl, no_surat, kpd, tglsurat, perihal) VALUES ('$tgl', '$no_surat', '$tglsurat', '$kpd', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="ndmasuk.php";</script>';
        }else{
...
<input type="date" name="tglsurat" class="form-control" placeholder="" >
</div>
