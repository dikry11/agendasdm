...
<head>
  ...
  <title>E-AGENDA | Input Surat Perintah Keluar</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasspkeluar">Surat Perintah Keluar</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_spkeluar (tgl, no_surat, kpd, perihal) VALUES ('$tgl', '$no_surat', '$kpd', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tasspkeluar.php";</script>';
        }else{
