...
<head>
  ...
  <title>E-AGENDA | SURAT BIASA KELUAR</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="taskeluar.php">Tabel</a></li>
        <li class="active">Surat Keluar Biasa</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <a href="id_biasakeluar.php" class="btn btn-primary"> <i class="fa fa-fw fa-edit"></i>TAMBAH DATA</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tasmasuk" width="100%" cellspacing="0">
                 <thead class="thead">
                  ...
                  <tbody>
                     <?php
                     $sql = mysqli_query($koneksi, "SELECT * FROM tb_sbkeluar") or die(mysqli_error($koneksi));
    ...
    echo '
              <tr>
                 ...
                 <td>'.$data['tgl'].'</td>
                  ...
                  <a href="editsbkeluar.php?id='.$data['id'].'" <button type="button" title="Edit" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></button></a>
