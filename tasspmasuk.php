...
<head>
  ...
  <title>E-AGENDA | Surat Perintah MASUK</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasspmasuk.php">Tabel</a></li>
        <li class="active">Surat Perintah Masuk</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <a href="idsmasuk.php" class="btn btn-primary"> <i class="fa fa-fw fa-edit"></i>TAMBAH DATA</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
...
if(ISSET($_REQUEST['ket'])){
  ...
  readfile("../uploads/".$ket);
}


                     $sql = mysqli_query($koneksi, "SELECT * FROM tb_spmasuk") or die(mysqli_error($koneksi));
    ...
    echo '
              <tr>
                 ...
                 <td>'.$data['ket'].'</td>
                  ...
                  <a href="editspmasuk.php?id='.$data['id'].'" <button type="button" title="Edit" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></button></a>
