...
<head>
  ...
  <title>E-AGENDA | Input Surat Rekomendasi</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasrekomen">Surat Rekomendasi</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_sr (tgl, no_surat, kpd, perihal) VALUES ('$tgl', '$no_surat', '$kpd', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tasrekomen.php";</script>';
        }else{
