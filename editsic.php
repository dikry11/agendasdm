...
<head>
  ...
  <title>E-AGENDA | EDIT SURAT IZIN CUTI</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_sic WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_sic SET  nama='$nama',pangkat='$pangkat', jabatan='$jabatan', tujuan='$tujuan', dari='$dari', sdtgl='$sdtgl', lamacuti='$lamacuti' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="tascuti.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editsic.php?id=<?php echo $id; ?>" method="post">
...
<input type="text" name="jabatan" class="form-control" placeholder="" value="<?php echo $data['jabatan'] ?>">
</div>
...
<input type="date" name="sdtgl" class="form-control" placeholder="" value="<?php echo $data['sdtgl'] ?>">
</div>

<div class="form-group">
<label><b>LAMA CUTI</b></label>
<input type="text" name="lamacuti" class="form-control" placeholder="" value="<?php echo $data['lamacuti'] ?>">
</div>



     <a href="tascuti.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
