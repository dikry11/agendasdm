...
<head>
  ...
  <title>E-AGENDA | EDIT NOTA DINAS MASUK</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_ndmasuk WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_ndmasuk SET  tgl='$tgl',no_surat='$no_surat', tglsurat='$tglsurat', kpd='$kpd', perihal='$perihal' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="ndmasuk.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editndmasuk.php?id=<?php echo $id; ?>" method="post">
...
<input type="text" name="perihal" class="form-control" placeholder="" value="<?php echo $data['perihal'] ?>">
      ...
      <a href="ndmasuk.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
