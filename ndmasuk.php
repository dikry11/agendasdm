...
<head>
  ...
  <title>E-AGENDA | NOTA DINAS MASUK</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ndmasuk.php">Tabel</a></li>
        <li class="active">Nota Dinas Masuk</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
             <a href="id_ndmasuk.php" class="btn btn-primary"> <i class="fa fa-fw fa-edit"></i>TAMBAH DATA</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <div class="table-responsive">
                <table class="table table-bordered" id="tasmasuk" width="100%" cellspacing="0">
                 <thead class="thead">
                  ...
                  <tbody>
                     <?php
                     $sql = mysqli_query($koneksi, "SELECT * FROM tb_ndmasuk") or die(mysqli_error($koneksi));
    ...
    echo '
              <tr>
                ...
                <a href="editndmasuk.php?id='.$data['id'].'" <button type="button" title="Edit" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i></button></a>
