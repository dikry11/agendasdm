...
<head>
  ...
  <title>E-AGENDA | EDIT SURAT IZIN JALAN</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Surat Izin Jalan</h3><br><br>  
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_sij WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_sij SET  nama='$nama',pangkat='$pangkat', keperluan='$keperluan', tujuan='$tujuan', dari='$dari', sampai='$sampai', angkutan='$angkutan' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="tasjalan.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editsij.php?id=<?php echo $id; ?>" method="post">
...
<label><b>NAMA</b></label>
  <input type="text" name="nama" class="form-control" placeholder="" value="<?php echo $data['nama'] ?>">
</div>

<div class="form-group">
<label><b>PANGKAT</b></label>
<input type="text" name="pangkat" class="form-control" placeholder="" value="<?php echo $data['pangkat'] ?>">
</div>


<div class="form-group">
<label><b>KEPERLUAN</b></label>
<input type="text" name="keperluan" class="form-control" placeholder="" value="<?php echo $data['keperluan'] ?>">
</div>

<div class="form-group">
<label><b>TUJUAN</b></label>
<input type="text" name="tujuan" class="form-control" placeholder="" value="<?php echo $data['tujuan'] ?>">
</div>

<div class="form-group">
<label><b>DARI</b></label>
<input type="date" name="dari" class="form-control" placeholder="" value="<?php echo $data['dari'] ?>">
</div>

<div class="form-group">
<label><b>SAMPAI</b></label>
<input type="date" name="sampai" class="form-control" placeholder="" value="<?php echo $data['sampai'] ?>">
</div>

<div class="form-group">
<label><b>ANGKUTAN</b></label>
<input type="text" name="angkutan" class="form-control" placeholder="" value="<?php echo $data['angkutan'] ?>">
</div>


<a href="tasjalan.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
