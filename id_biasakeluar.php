...
<head>
  ...
  <title>E-AGENDA | Input Surat Biasa Keluar</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="taskeluar.php">Surat Keluar Biasa</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_sbkeluar (tgl, no_surat, kpd, perihal) VALUES ('$tgl', '$no_surat', '$kpd', '$perihal')";
  $result  = mysqli_query($koneksi, $mysqli);

   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="taskeluar.php";</script>';
        }else{
