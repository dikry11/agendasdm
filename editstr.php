...
<head>
  ...
  <title>E-AGENDA | EDIT SURAT TELEGRAM</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Surat Telegram</h3><br><br>  
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_str WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_str SET  tgl='$tgl',no_surat='$no_surat', tglsurat='$tglsurat', perihal='$perihal' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="tastelegram.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editstr.php?id=<?php echo $id; ?>" method="post">
...
<input type="text" name="tglsurat" class="form-control" placeholder="" value="<?php echo $data['tglsurat'] ?>">
</div>
...
<input type="text" name="perihal" class="form-control" placeholder="" value="<?php echo $data['perihal'] ?>">
      ...
      <a href="tastelegram.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
