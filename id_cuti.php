...
<head>
  ...
  <title>E-AGENDA | Input Surat Izin Cuti</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tascuti.php">Surat Izin Cuti</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_sic (nama, pangkat, jabatan, tujuan, dari, sdtgl, lamacuti) VALUES('$nama', '$pangkat', '$jabatan', '$tujuan',  '$dari', '$sdtgl', '$lamacuti')" ;
  $result  = mysqli_query($koneksi, $mysqli);



   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tascuti.php";</script>';
        }else{
...
<label><b>PANGKAT</b></label>
  <input type="text" name="pangkat" class="form-control" placeholder="" >
</div>
...
<input type="date" name="sdtgl" class="form-control" placeholder="" >
</div>

<div class="form-group">
<label><b>LAMA CUTI</b></label>
<input type="text" name="lamacuti" class="form-control" placeholder="" >
</div>
