...
<head>
  ...
  <title>E-AGENDA | EDIT NOTA DINAS KELUAR</title>
...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_ndkeluar WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_ndkeluar SET  tgl='$tgl',no_surat='$no_surat', tglsurat='$tglsurat', kpd='$kpd', perihal='$perihal' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="ndkeluar.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editndkeluar.php?id=<?php echo $id; ?>" method="post">
...
<label><b>TANGGAL SURAT</b></label>
  <input type="date" name="tglsurat" class="form-control" placeholder="" value="<?php echo $data['tglsurat'] ?>">
</div>

<div class="form-group">
<label><b>KEPADA</b></label>
<input type="text" name="kpd" class="form-control" placeholder="" value="<?php echo $data['kpd'] ?>">
</div>
...
<input type="text" name="perihal" class="form-control" placeholder="" value="<?php echo $data['perihal'] ?>">
    ...
    <a href="ndkeluar.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
