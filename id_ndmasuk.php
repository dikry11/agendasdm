...
<head>
  ...
  <title>E-AGENDA | Input Nota Dinas Masuk</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="ndmasuk.php">Nota Dinas Masuk</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_ndmasuk (tgl, no_surat, kpd, tglsurat, perihal) VALUES ('$tgl', '$no_surat', '$tglsurat', '$kpd', '$perihal')";
