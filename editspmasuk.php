...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    if(isset($_GET['id'])){
      ...
      $select = mysqli_query($koneksi, "SELECT * FROM tb_spmasuk WHERE id='$id'") or die(mysqli_error($koneksi));
  ...
  if(isset($_POST['bsimpan'])){
      ...
      $sql = mysqli_query($koneksi, "UPDATE tb_spmasuk SET tgl='$tgl', no_surat='$no_surat',dari='$dari', perihal='$perihal', ket='$ket' WHERE id='$id'") or die(mysqli_error($koneksi));
      
      if($sql){
        echo '<script>alert("Berhasil menyimpan data."); document.location="tasspmasuk.php?id='.$id.'";</script>';
      }else{
    ...
    <form action="editspmasuk.php?id=<?php echo $id; ?>" method="post">
...
<input type="text" name="ket" class="form-control" placeholder="" value="<?php echo $data['ket'] ?>">
</div><br>

     <a href="tasspmasuk.php" class="btn btn-danger"><span class="glyphicon glyphicon-remove"></span> Cancel</a>
