...
<head>
  ...
  <title>E-AGENDA | Input Surat Izin Jalan</title>
 ...
 <!-- Begin Page Content -->
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li><a href="tasjalan/php">Surat Izin Jalan</a></li>
...
<?php
 if(isset($_POST['bsimpan'])){
  ...
  $mysqli  = "INSERT INTO tb_sij (nama, pangkat, keperluan, tujuan, dari, sampai, angkutan) VALUES('$nama', '$pangkat', '$keperluan', '$tujuan',  '$dari', '$sampai', '$angkutan')" ;
  $result  = mysqli_query($koneksi, $mysqli);



   if($result){
          echo '<script>alert("Berhasil menambahkan data."); document.location="tasjalan.php";</script>';
        }else{
...
<input type="text" name="angkutan" class="form-control" placeholder="" >
</div>
